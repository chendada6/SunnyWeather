...
class WeatherActivity : AppCompatActivity() {
    ...
    private lateinit var nowLayout: RelativeLayout // 当前天气布局
    private lateinit var forecastLayout: LinearLayout // 预报列表布局
    private lateinit var weatherLayout: ScrollView // 整体天气布局
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
     ...
     private fun showWeatherInfo(weather: Weather) {
         ...
         carWashingText.text = lifeIndex.carWarning[0].desc
