...
private val sky = mapOf(
    ...
    "PARTLY_CLOUDY_DAY" to Sky("多云", R.drawable.ic_partly_cloud_night, R.drawable.bg_partly_cloudy_night),
    ...
    "THUNDER_RAIN" to Sky("雷阵雨", R.drawable.ic_thunder_shower, R.drawable.bg_rain),
    ...
    "STORM_SNOW" to Sky("暴雪", R.drawable.ic_storm_rain, R.drawable.bg_snow),
